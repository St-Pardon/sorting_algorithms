...
| [Cocktail Sort](./101-cocktail_sort_list.c)  | function that sorts a doubly linked list of integers in ascending order using the [Cocktail shaker sort](https://alx-intranet.hbtn.io/rltoken/bwa4mHfUbbWTB8J2OIHvpA) algorithm |
| [Counting Sort](./102-counting_sort.c) | function that sorts an array of integers in ascending order using the [Counting sort](https://alx-intranet.hbtn.io/rltoken/ChcoDSCqnJHGC-qrSPEGHQ) algorithm |
| [Merge Sort](./103-merge_sort.c) | function that sorts an array of integers in ascending order using the [Merge sort](https://alx-intranet.hbtn.io/rltoken/8sZ3nAhd_YLNzHCgNbbf8A) algorithm |
| [Heap Sort](./104-heap_sort.c) | function that sorts an array of integers in ascending order using the [Heap sort](https://alx-intranet.hbtn.io/rltoken/YKYRdSdomaVkNrtNv1KS6Q) algorithm |
| [Radix Sort](./105-radix_sort.c) | function that sorts an array of integers in ascending order using the [Radix sort](https://alx-intranet.hbtn.io/rltoken/pBsj4j_AF_mJAgNZWmX3VQ) algorithm |